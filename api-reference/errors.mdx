---
title: 'Errors'
'og:title': 'Eigen Explorer API returns machine readable error codes, human readable error messages and a link to the docs for more information'
description: 'Troubleshoot problems with this comprehensive breakdown of all error codes.'
---

Eigen Explorer API returns machine readable error codes, human readable error messages and a link to the docs for more information.
...
```json
{
    "error": {
        ...
        "doc_url": "https://api.eigenexplorer.com/api-reference/errors#not_found"
    }
}
```
...
Here is a list of all error codes Eigen Explorer API returns:
